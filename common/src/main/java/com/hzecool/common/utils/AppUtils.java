...
public class AppUtils {
    ...
    public static boolean isInstallApp(Context context, String packageName) {
        return !StringCovertUtils.isSpace(packageName) && IntentUtils.getLaunchAppIntent(context, packageName) != null;
    }
    ...
    public static void uninstallApp(Context context, String packageName) {
        if (StringCovertUtils.isSpace(packageName)) {
            return;
        }
    ...
    public static boolean isAppForeground(Context context, String packageName) {
        return !StringCovertUtils.isSpace(packageName) && packageName.equals(ProcessUtils.getForegroundProcessName());
    }
