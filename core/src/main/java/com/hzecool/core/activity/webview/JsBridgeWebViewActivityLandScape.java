 ...
 * @author tutu
 */
@Route(path = ARouterUrl.AR_URL_WEB_VIEW_LANDSCAPE)
public class JsBridgeWebViewActivityLandScape extends TBaseActivity<IJsBridgeWebViewView, WebViewPresenter>
        implements IJsBridgeWebViewView {
    ...
    public void initView() {
        ...
        if (!TextUtils.isEmpty(url)) {
            L.logFile("JsBridgeWebViewActivity url==" + url);
            webview.loadUrl(url);
        }
