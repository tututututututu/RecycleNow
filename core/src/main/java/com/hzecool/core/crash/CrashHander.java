...
@SuppressLint("NewApi")
public final class CrashHander {

    private final static String TAG = "CrashHander";
    ...
    private static int defaultErrorActivityDrawableId = R.mipmap.customactivityoncrash_error_image;
    ...
    /**
     * Installs CrashHander on the application using the default error activity.
     *
        ...
        try {
            if (context == null) {
                ...
                if (android.os.Build.VERSION.SDK_INT < Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
                    Log.w(TAG, "CrashHander will be installed, but may not be reliable in API lower than 14");
                }
                ...
                if (oldHandler != null && oldHandler.getClass().getName().startsWith(CAOC_HANDLER_PACKAGE_NAME)) {
                    Log.e(TAG, "You have already installed CrashHander, doing nothing!");
                } else {
                    if (oldHandler != null && !oldHandler.getClass().getName().startsWith(DEFAULT_HANDLER_PACKAGE_NAME)) {
                        Log.e(TAG, "IMPORTANT WARNING! You already have an UncaughtExceptionHandler, are you sure this is correct? If you use ACRA, Crashlytics or similar libraries, you must initialize them AFTER CrashHander! Installing anyway, but your original handler will not be called.");
                    }
                    ...
                    Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
                        ...
                        public void uncaughtException(Thread thread, final Throwable throwable) {
                            Log.e(TAG, "App has crashed, executing CrashHander's UncaughtExceptionHandler", throwable);
                    ...
                    Log.i(TAG, "CrashHander has been installed.");
                }
            }
        } catch (Throwable t) {
            Log.e(TAG, "An unknown error occurred while installing CrashHander, it may not have been properly initialized. Please report this as a bug if needed.", t);
        }
    }
    ...
    public static boolean isShowErrorDetailsFromIntent(Intent intent) {
        return intent.getBooleanExtra(CrashHander.EXTRA_SHOW_ERROR_DETAILS, true);
    }
    ...
    public static int getDefaultErrorActivityDrawableIdFromIntent(Intent intent) {
        return intent.getIntExtra(CrashHander.EXTRA_IMAGE_DRAWABLE_ID, R.mipmap.customactivityoncrash_error_image);
    }
    ...
    public static String getStackTraceFromIntent(Intent intent) {
        return intent.getStringExtra(CrashHander.EXTRA_STACK_TRACE);
    }
    ...
    public static Class<? extends Activity> getRestartActivityClassFromIntent(Intent intent) {
        Serializable serializedClass = intent.getSerializableExtra(CrashHander.EXTRA_RESTART_ACTIVITY_CLASS);
    ...
    public static EventListener getEventListenerFromIntent(Intent intent) {
        Serializable serializedClass = intent.getSerializableExtra(CrashHander.EXTRA_EVENT_LISTENER);
    ...
    public static void setLaunchErrorActivityWhenInBackground(boolean launchErrorActivityWhenInBackground) {
        CrashHander.launchErrorActivityWhenInBackground = launchErrorActivityWhenInBackground;
    }
    ...
    public static void setShowErrorDetails(boolean showErrorDetails) {
        CrashHander.showErrorDetails = showErrorDetails;
    }
    ...
    public static void setDefaultErrorActivityDrawable(int defaultErrorActivityDrawableId) {
        CrashHander.defaultErrorActivityDrawableId = defaultErrorActivityDrawableId;
    }
    ...
    public static void setEnableAppRestart(boolean enableAppRestart) {
        CrashHander.enableAppRestart = enableAppRestart;
    }
    ...
    public static void setErrorActivityClass(Class<? extends Activity> errorActivityClass) {
        CrashHander.errorActivityClass = errorActivityClass;
    }
    ...
    public static void setRestartActivityClass(Class<? extends Activity> restartActivityClass) {
        CrashHander.restartActivityClass = restartActivityClass;
    }
    ...
    public static void setEventListener(EventListener eventListener) {
        if (eventListener != null && eventListener.getClass().getEnclosingClass() != null && !Modifier.isStatic(eventListener.getClass().getModifiers())) {
            ...
            CrashHander.eventListener = eventListener;
        }
    }
