...
import static com.hzecool.app.data.AppData.CRASH_SHOW;
...
public final class DefaultErrorActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        L.logFile(CrashHander.getAllErrorDetailsFromIntent(DefaultErrorActivity.this, getIntent()));
        ...
        final Class<? extends Activity> restartActivityClass = CrashHander.getRestartActivityClassFromIntent(getIntent());
        final CrashHander.EventListener eventListener = CrashHander.getEventListenerFromIntent(getIntent());
        ...
        if (restartActivityClass != null) {
            ...
            restartButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    CrashHander.restartApplicationWithIntent(DefaultErrorActivity.this, intent, eventListener);
                }
            });
        } else {
            restartButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    CrashHander.closeApplication(DefaultErrorActivity.this, eventListener);
                }
            });
        }
        ...
        if (CrashHander.isShowErrorDetailsFromIntent(getIntent())) {
            ...
            moreInfoButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    AlertDialog dialog = new AlertDialog.Builder(DefaultErrorActivity.this)
                            ...
                            .setMessage(CrashHander.getAllErrorDetailsFromIntent(DefaultErrorActivity.this, getIntent()))
        ...
        int defaultErrorActivityDrawableId = CrashHander.getDefaultErrorActivityDrawableIdFromIntent(getIntent());
    ...
    private void copyErrorToClipboard() {
        String errorInformation =
                CrashHander.getAllErrorDetailsFromIntent(DefaultErrorActivity.this, getIntent());
