...
public class FileDownUpLoad {
    ...
    public static void downLoadFile(String tag, String url, String destFileDir, String name,
        ...
        OkGo.get(url)
                ...
                .execute(new FileCallback(destFileDir, name) {
                    @Override
    ...
    FileUploadCallBackInterface uploadCallBackInterface, @Nullable WeakReference<TAbsActivity> activity,
        ...
        params.put(ParamConstant.SESSIONID, UserData.sessionid);
        OkGo.post(url)
                .tag(tag)
