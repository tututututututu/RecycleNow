...
public class FinalSPOperation {
    ...
    public static boolean isAutoPrint() {
        return FinalSPOperation.getBoolean(ParamConstant.IS_AUTO_PRINT);
    }

    public static void putAutoPrint(boolean isAutoPrint){
        FinalSPOperation.putBoolean(ParamConstant.IS_AUTO_PRINT, isAutoPrint);
    }
}
