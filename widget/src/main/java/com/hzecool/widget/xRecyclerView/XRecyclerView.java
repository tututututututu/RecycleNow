...
public class XRecyclerView extends RecyclerView {
	...
	public static String ADDMORE = "addmore";
	...
	private class WrapAdapter extends Adapter<ViewHolder> {
			...
			if (adapter != null) {
				...
				if (adjPosition < adapterCount) {
					...
					if (isReservedItemViewType(type)) {
						throw new IllegalStateException("XRecyclerView require itemViewType in adapter should be less " +
                            "than 10000 ");
					}
					return type;
				}
		...
		public void onViewAttachedToWindow(ViewHolder holder) {
			...
			if (lp != null
				...
				&& (isHeader(holder.getLayoutPosition()) || isRefreshHeader(holder.getLayoutPosition()) || isFooter
